...
describe('Testing ruoff.nestready.co', function() {
    ...
    describe('Testing the properties page filters', function() {
    ...
    describe('Testing other features in the properties page', function() {
    ...
    describe('Testing the single property page', function (){
